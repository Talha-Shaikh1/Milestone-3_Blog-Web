      ...
      <div className="max-w-6xl mx-auto rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="p-6 md:p-10">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 leading-relaxed md:leading-loose md:text-lg">
              At <strong>Our Blog</strong>, we are passionate about sharing insightful articles, 
          ...
          <div className="mt-16">
            <h3 className="text-2xl font-bold text-gray-800 text-center mb-6">Meet the Team</h3>
